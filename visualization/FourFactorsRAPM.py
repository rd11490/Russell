...
results_adjusted = calculate_rapm(stintY_adjusted, stintX_adjusted, possessions_adjusted, lambdas_rapm,
                                  "LA-RAPM", "PointsPerPossession", stints.copy(True))
results_raw = calculate_rapm(stintY_raw, stintX_raw, possessions_raw, lambdas_rapm, "RAPM",
                             "ExpectedPointsPerPossession",
                             stints.copy(True))
results_turnover = calculate_rapm(stintY_turnover, stintX_turnover, possessions_turnover, lambdas_turnover,
                                  "RA-TOV", "TurnoverPercent", stints.copy(True))
results_efg = calculate_rapm(stintY_efg, stintX_efg, possessions_efg, lambdas_efg,
                             "RA-EFG", "EffectiveFieldGoalPercent",
                             stints_EFG.copy(True))
results_orbd = calculate_rapm(stintY_orbd, stintX_orbd, possessions_orbd, lambdas,
                              "RA-ORBD", "OffensiveReboundPercent", stints_ORB.copy(True))
results_ftr = calculate_rapm(stintY_ftr, stintX_ftr, possessions_ftr, lambdas_ftr, "RA-FTR",
