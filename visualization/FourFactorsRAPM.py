...
stintX_adjusted, stintY_adjusted, possessions_adjusted = extract_stints(stints.copy(True), "ExpectedPointsPerPossession")
...
def calculate_rapm(stintY, stintX, possessions, name):
...
results_adjusted = calculate_rapm(stintY_adjusted, stintX_adjusted, possessions_adjusted, "Luck Adjusted Real Adjusted Plus Minus")
results_raw = calculate_rapm(stintY_raw, stintX_raw, possessions_raw, "Real Adjusted Plus Minus")
results_turnover = calculate_rapm(stintY_turnover, stintX_turnover, possessions_turnover, "Real Adjusted Turnover Rate")
results_efg = calculate_rapm(stintY_efg, stintX_efg, possessions_efg, "Real Adjusted Effective Field Goal Percent")
results_orbd = calculate_rapm(stintY_orbd, stintX_orbd, possessions_orbd, "Real Adjusted Offensive Rebound Rate")
results_ftr = calculate_rapm(stintY_ftr, stintX_ftr, possessions_ftr, "Real Adjusted Free Throw Rate")
