...
def plot(d, o, teamName):
    ...
    plt.plot(dTeam["games"], dTeam["ePPS100"], c="r", label="Defense ePPS100")
    plt.plot(oTeam["games"], oTeam["ePPS100"], c="g", label="Offense ePPS100")
...
for t in teams:
    ...
    plt.legend()
    plt.title("ePPS100:\n {}".format(t))
    plt.savefig("plots/ePPS100/{}".format(t))
    plt.close()
    #plt.show()
