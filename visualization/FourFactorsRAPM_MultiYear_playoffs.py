...
seasons = ["2016-19", "2015-18", "2014-17", "2013-16"]
...
for season in seasons:
    ...
    stints_query = "SELECT * FROM nba.luck_adjusted_one_way_stints where season = '{0}';".format(season)
    ...
    merged.to_csv("results/Real Adjusted Four Factors {} all.csv".format(season))
