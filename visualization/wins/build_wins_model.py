...
training_data['LA_RAPM_O_RTG_diff'] = training_data['LA_RAPM_O_RTG_home']-training_data['LA_RAPM_O_RTG_away']
training_data['LA_RAPM_D_RTG_diff'] = training_data['LA_RAPM_D_RTG_home']-training_data['LA_RAPM_D_RTG_away']

training_data['NET_home'] = training_data['LA_RAPM_O_RTG_home']-training_data['LA_RAPM_D_RTG_home']
training_data['NET_away'] = training_data['LA_RAPM_O_RTG_away']-training_data['LA_RAPM_D_RTG_away']

training_data['NET_diff'] = training_data['NET_home']-training_data['NET_away']


training_data['RA_EFG_O_diff'] = training_data['RA_EFG_O_home']-training_data['RA_EFG_O_away']
training_data['RA_EFG_D_diff'] = training_data['RA_EFG_D_home']-training_data['RA_EFG_D_away']

training_data['RA_TOV_O_diff'] = training_data['RA_TOV_O_home']-training_data['RA_TOV_O_away']
training_data['RA_TOV_D_diff'] = training_data['RA_TOV_D_home']-training_data['RA_TOV_D_away']

training_data['RA_ORBD_O_diff'] = training_data['RA_ORBD_O_home']-training_data['RA_ORBD_O_away']
training_data['RA_ORBD_D_diff'] = training_data['RA_ORBD_D_home']-training_data['RA_ORBD_D_away']

training_data['RA_FTR_O_diff'] = training_data['RA_FTR_O_home']-training_data['RA_FTR_O_away']
training_data['RA_FTR_D_diff'] = training_data['RA_FTR_D_home']-training_data['RA_FTR_D_away']


train = training_data[training_data['season'].isin(['2015-16', '2016-17', '2017-18'])]

"""
train_cols = ["LA_RAPM_O_RTG_home", "LA_RAPM_D_RTG_home", 'RA_EFG_O_home', 'RA_EFG_D_home', 'RA_TOV_O_home', 'RA_TOV_D_home', 'RA_ORBD_O_home',
           'RA_ORBD_D_home', 'RA_FTR_O_home', 'RA_FTR_D_home',"LA_RAPM_O_RTG_away", "LA_RAPM_D_RTG_away",  'RA_EFG_O_away', 'RA_EFG_D_away',
...
train_cols = ['RA_EFG_O_home', 'RA_EFG_D_home', 'RA_TOV_O_home', 'RA_TOV_D_home', 'RA_ORBD_O_home',
           'RA_ORBD_D_home', 'RA_FTR_O_home', 'RA_FTR_D_home', 'RA_EFG_O_away', 'RA_EFG_D_away',
           'RA_TOV_O_away', 'RA_TOV_D_away', 'RA_ORBD_O_away', 'RA_ORBD_D_away', 'RA_FTR_O_away',
           'RA_FTR_D_away']
Y = train['homeWin']
X = train[train_cols]
...
pickle.dump(clf, open('random_forrest_wins.sav', 'wb'))
...
schedule_input['LA_RAPM_O_RTG_diff'] = schedule_input['LA_RAPM_O_RTG_home']-schedule_input['LA_RAPM_O_RTG_away']
schedule_input['LA_RAPM_D_RTG_diff'] = schedule_input['LA_RAPM_D_RTG_home']-schedule_input['LA_RAPM_D_RTG_away']

schedule_input['NET_home'] = schedule_input['LA_RAPM_O_RTG_home']-schedule_input['LA_RAPM_D_RTG_home']
schedule_input['NET_away'] = schedule_input['LA_RAPM_O_RTG_away']-schedule_input['LA_RAPM_D_RTG_away']

schedule_input['NET_diff'] = schedule_input['NET_home']-schedule_input['NET_away']

schedule_input['RA_EFG_O_diff'] = schedule_input['RA_EFG_O_home']-schedule_input['RA_EFG_O_away']
schedule_input['RA_EFG_D_diff'] = schedule_input['RA_EFG_D_home']-schedule_input['RA_EFG_D_away']

schedule_input['RA_TOV_O_diff'] = schedule_input['RA_TOV_O_home']-schedule_input['RA_TOV_O_away']
schedule_input['RA_TOV_D_diff'] = schedule_input['RA_TOV_D_home']-schedule_input['RA_TOV_D_away']

schedule_input['RA_ORBD_O_diff'] = schedule_input['RA_ORBD_O_home']-schedule_input['RA_ORBD_O_away']
schedule_input['RA_ORBD_D_diff'] = schedule_input['RA_ORBD_D_home']-schedule_input['RA_ORBD_D_away']

schedule_input['RA_FTR_O_diff'] = schedule_input['RA_FTR_O_home']-schedule_input['RA_FTR_O_away']
schedule_input['RA_FTR_D_diff'] = schedule_input['RA_FTR_D_home']-schedule_input['RA_FTR_D_away']
...
res_h = schedule_input.groupby(by='homeTeam')['predict'].sum().reset_index()
res_a= schedule_input.groupby(by='awayTeam')['predict'].sum().reset_index()
res_h.columns = ['teamId', 'pred_home']
res_a.columns = ['teamId', 'pred_away']

res = res_h.merge(res_a, on='teamId')
res['wins'] = res['pred_home'] + res['pred_away']
print(res.head(30))
