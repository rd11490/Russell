...
seasons = ["2014-19","2013-18","2012-17","2011-16", "2010-15", "2016-19", "2015-18", "2014-17", "2013-16", "2012-15", "2011-14", "2010-13"]
...
for season in seasons:
    ...
    stints_query = "SELECT * FROM nba.luck_adjusted_one_way_stints where seasonType = '{1}' and possessions > 0 and season = '{0}';".format(season, seasonType)
    ...
    def extract_stints(stints_for_extraction, name):
        ...
        possessions = (stints_for_extraction["possessions"]/stints_for_extraction["possessions"].sum()).values
    ...
    merged.to_csv("results/Real Adjusted Four Factors {} TEST3.csv".format(season))

    end = datetime.datetime.now()

    elapsed = end - start

    print("Total Time To Run {} Seconds".format(elapsed))
