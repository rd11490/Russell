...
object RawGameSummaryExtraStats extends ResultSetMapper {

  def apply(otherStats: OtherStats, gameId: String, dt: String, season: Option[String]): RawGameSummaryExtraStats =
    RawGameSummaryExtraStats(
